...
export function ToolPageShell({
  ...
  description,
  icon,
  badge = "मुफ़्त • सुरक्षित • तुरंत परिणाम",
  children,
}: ToolPageShellProps) {
  return (
    <>
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 py-12 sm:px-8 sm:py-16 lg:px-10">
            ...
            <div className="mt-7 max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#173f35]/15 bg-white/75 px-4 py-2 text-sm font-bold text-[#173f35] shadow-sm">
                <span aria-hidden="true">{icon}</span> {badge}
              </div>
              <h1 className="mt-6 text-4xl font-black tracking-[-0.04em] text-[#132b25] sm:text-6xl">{title}</h1>
